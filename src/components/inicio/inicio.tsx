          ...
          <div className="w-full md:w-[55%] p-4 md:p-4 flex justify-center items-center hidden md:block">
            <div className="w-full max-w-lg mx-auto bg-white shadow-lg rounded-2xl p-6 flex justify-center items-center text-center">
              <p className="text-lg text-gray-700">
                🍔 Bem-vindo ao Nick&apos;s Burger! 🍔 Aqui no Nick&apos;s
                Burger, a arte do hambúrguer artesanal é nossa paixão! Com
                ingredientes frescos, receitas exclusivas e muito amor, criamos
                hambúrgueres que vão deixar o seu paladar pedindo mais. Cada
                mordida é uma explosão de sabor feita especialmente para você,
                seja para uma refeição rápida ou para curtir com a galera. No
                nosso cardápio, você encontra opções irresistíveis que combinam
                qualidade, sabor e aquele toque especial que só o Nick&apos;s
                Burger pode oferecer. Agradecemos por escolher o Nick&apos;s
                Burger. Estamos prontos para surpreender o seu apetite! 😋
              </p>
            </div>
          </div>
        </div>
